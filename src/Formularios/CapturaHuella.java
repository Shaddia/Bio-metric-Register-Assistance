...
public class CapturaHuella extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        panHuellas.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Huella Digital Capturada", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Forte", 0, 12), new java.awt.Color(153, 153, 153))); // NOI18N
        ...
        panBtns.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Acciones", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Forte", 0, 12), new java.awt.Color(153, 153, 153))); // NOI18N
        ...
        btnSalir.setFont(new java.awt.Font("Forte", 0, 14)); // NOI18N
        ...
        btnVerificar.setFont(new java.awt.Font("Forte", 0, 14)); // NOI18N
        ...
        btnIdentificar.setFont(new java.awt.Font("Forte", 0, 14)); // NOI18N
        btnIdentificar.setForeground(new java.awt.Color(153, 153, 153));
        ...
        btnGuardar.setFont(new java.awt.Font("Forte", 0, 14)); // NOI18N
        ...
        jLabel28.setFont(new java.awt.Font("Forte", 0, 12)); // NOI18N
...
// necesarias de la huella si no ha ocurrido ningun problema
  ...
  * Guarda los datos de la huella digital actual en la base de datos
    ...
    private static final String SQL_INSERT = "INSERT INTO huella(nomhuella,huellahuella) values (?,?)";

    public void guardarHuella() {
        //Obtiene los datos del template de la huella actual
        ByteArrayInputStream datosHuella = new ByteArrayInputStream(template.serialize());
        int tamanoHuella = template.serialize().length;
        System.err.println("datos: " + tamanoHuella);
        //Pregunta el nombre de la persona a la cual corresponde dicha huella
        String nombre = JOptionPane.showInputDialog("Nombre huella: ");
       String consul= "SELECT * FROM huella ORDER by id DESC LIMIT 0,1";
        RegistroPersonalEstudiantil rpe = new RegistroPersonalEstudiantil();
        rpe.setVisible(true);
        try (Connection conn = con.conectar();
                PreparedStatement preparedStatement = conn.prepareStatement(SQL_INSERT)) {
            preparedStatement.setString(1, nombre);
            preparedStatement.setBlob(2, datosHuella, tamanoHuella);
    ...
    public void buscarComparar() {
        ...
        if (encontrado == true) {
            ...
            try {
                ...
                if (datosAlumno.next()) {
                nombreAlumno = datosAlumno.getString("1er_nombre");
                nombreAlumno +=" ";
                nombreAlumno += datosAlumno.getString("2do_nombre");
                nombreAlumno +=" ";
                nombreAlumno += datosAlumno.getString("1er_apellido");
                nombreAlumno +=" ";
                nombreAlumno += datosAlumno.getString("2do_apellido");
                JOptionPane.showMessageDialog(null, "Esta huella pertenece a: " + nombreAlumno);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "BAD");
            }
    ...
    public void verificarHuella(String nom) {
        try {
            ...
            PreparedStatement verificarStmt = c.prepareStatement("SELECT huellahuella FROM huella WHERE nomhuella=?");
